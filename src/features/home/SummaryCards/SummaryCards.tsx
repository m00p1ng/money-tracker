    ...
    <div>
      ...
      <motion.div className="grid grid-cols-2 gap-3" variants={containerVariants} initial="hidden" animate="visible">
        <motion.div
          ...
          className="rounded-2xl border border-income/20 bg-gradient-to-br from-income/10 to-income/5 p-4 backdrop-blur"
        >
        ...
        <motion.div
          variants={cardVariants}
          className={[
            'rounded-2xl border border-expense/20',
            'bg-gradient-to-br from-expense/10 to-expense/5 p-4 backdrop-blur',
          ].join(' ')}
        >
